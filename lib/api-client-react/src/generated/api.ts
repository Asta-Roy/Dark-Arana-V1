 ...
 */
export const getOpenaiStats = async ( options?: RequestInit): Promise<OpenaiStats> => {
...
export const getGetOpenaiStatsQueryOptions = <TData = Awaited<ReturnType<typeof getOpenaiStats>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOpenaiStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetOpenaiStatsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getOpenaiStats>>> = ({ signal }) => getOpenaiStats({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getOpenaiStats>>, TError, TData> & { queryKey: QueryKey }
}

export type GetOpenaiStatsQueryResult = NonNullable<Awaited<ReturnType<typeof getOpenaiStats>>>
...
export function useGetOpenaiStats<TData = Awaited<ReturnType<typeof getOpenaiStats>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOpenaiStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
